...
public class SyncPosRot : Photon.MonoBehaviour
{
	private Quaternion lastCorrectRot;
	...
	public void Awake()
	{
		...
		lastCorrectRot = transform.rotation;
	...
	public void Update()
	{
		...
		if(syncRot)
			transform.localRotation = Quaternion.Lerp(onUpdateRot, lastCorrectRot, fraction);
	}
}
